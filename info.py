...
PICS = (environ.get('PICS', 'https://telegra.ph/file/be3dc6a6bb3e674ec887d.jpg https://telegra.ph/file/662581f31adbd8c848e01$
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://aman:aman@cluster0.chnpche.mongodb.net/?retryWrites=true&w=majorit$DATABASE_NAME = environ.get('DATABASE_NAME', "Anurag143")
...
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", "<b>Query: {query}</b> \n ^`^l ^`^l ^`^l ^`^lIMDb Data:\n\n ^=^o  Title: <a hre$LONG_IMDB_DESCRIPTION = is_enabled(environ.get("LONG_IMDB_DESCRIPTION", "False"), False)
